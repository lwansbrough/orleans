...
namespace Orleans
{
    public interface IGrainFactory
    {
        ...
        TGrainInterface GetGrain<TGrainInterface>(byte[] primaryKey, string grainClassNamePrefix = null) where TGrainInterface : IGrainWithBinaryKey;
        ...
        /// <param name="grainClassNamePrefix">An optional class name prefix used to find the runtime type of the grain.</param>
        /// <returns>A reference to the specified grain.</returns>
        TGrainInterface GetGrain<TGrainInterface>(byte[] primaryKey, string keyExtension, string grainClassNamePrefix = null) where TGrainInterface : IGrainWithBinaryCompoundKey;
